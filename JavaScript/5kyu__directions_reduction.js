...
a needless effort. Since this is the wild west, with dreadful weather and
...
Notes
Not all paths can be made simpler. The path ["NORTH", "WEST", "SOUTH", "EAST"] is
...
function areOposites(direction1, direction2) {
  if (direction1 === "NORTH" && direction2 === "SOUTH") {
    return true;
  }

  if (direction2 === "NORTH" && direction1 === "SOUTH") {
    return true;
  }
  ...
  if (direction2 === "EAST" && direction1 === "WEST") {
    return true;
  }
